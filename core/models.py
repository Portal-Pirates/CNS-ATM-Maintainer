...
Maintain_TYPE_CHOICES = [
    ('Maintainable_and_Replacable', 'Maintainable and Replacable'),
...
class Profile(models.Model):
    ...
    working_location = models.CharField(max_length=2000, null=True, blank=True)
...
class Equipments(models.Model):
    ...
    created = models.DateTimeField(auto_now_add=True, editable=False)
    last_updated = models.DateTimeField(auto_now=True, editable=False)
    replacement_date = models.DateField(blank = True, null = True, default = None)
    maintainence_date = models.DateField(blank= True, null = True, default = None)
    is_replace = models.BooleanField(blank = True,null = True, default=False)
    is_maintain = models.BooleanField(blank= True, null = True, default=False)
    is_both = models.BooleanField(blank= True, null= True, default=True)
    station_name = models.CharField(max_length=2000, null=True, blank=True)
    class Meta:
...
class FaultTable(models.Model):
    ...
    Remarks = models.TextField(choices=Maintain_TYPE_CHOICES) #useful for getting type of service
...
class PredictedTable(models.Model):
    Equipment_Name = models.CharField(max_length = 20)
    prediction = models.IntegerField() #useful to get date of service
