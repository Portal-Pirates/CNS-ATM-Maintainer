...
@admin.register(FaultTable)
class FaultTable(admin.ModelAdmin):
    list_display = ['Equipment_Name','Date_Added','Date_Removed','Remarks','duration_it_worked']
    list_filter = ['Equipment_Name']
    list_per_page = 20

@admin.register(PredictedTable)
class PredictedTable(admin.ModelAdmin):
    list_display = ['Equipment_Name','prediction']
    list_filter = ['Equipment_Name']
